...
const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    // Navbar
    "nav.howItWorks": "Как пользоваться?",
    "nav.faq": "Часто задаваемые вопросы",
    "nav.businessRegister": "Регистрация бизнеса",
    "nav.businessLogin": "Вход для бизнеса",
    "nav.privacy": "Конфиденциальность",
    "nav.contact": "Контакты",
    
    // Hero Section
    "hero.badge": "Мир, полный скидок",
    "hero.title1": "Каждый час",
    "hero.title2": "новая возможность",
    "hero.subtitle": "Умная платформа скидок для бизнеса и пользователей. Открой лучшие предложения рядом с собой и экономь сразу.",
    "hero.stat1": "Активных кампаний",
    "hero.stat2": "Довольных пользователей",
    "hero.stat3": "Общая экономия",
    "hero.stat4": "Партнёрских заведений",
    
    // World of Discounts
    "world.title": "Мир, полный скидок",
    "world.description": "diKey это умная платформа выгодных предложений, которая позволяет мгновенно находить самые выгодные скидки в зависимости от вашего местоположения и времени. Она объединяет специальные предложения из кафе, ресторанов, магазинов и многих других заведений, помогая вам получать больше, платя меньше. Скачайте приложение бесплатно прямо сейчас, найдите лучшие предложения рядом с вами и начните экономить уже сегодня.",
    "world.feature1.title": "Простота использования",
    "world.feature1.desc": "Мгновенный доступ к скидкам благодаря удобному интерфейсу",
    "world.feature2.title": "Безопасная платформа",
    "world.feature2.desc": "Соответствие KVKK, зашифрованное управление данными",
    "world.feature3.title": "Широкая сеть",
    "world.feature3.desc": "Растущая экосистема с сотнями партнёрских заведений",
    
    // Discount Hours
    "discount.badge": "Умное планирование",
    "discount.title": "Выгодные часы скидок",
    "discount.description": "С функцией \"Выгодные часы скидок\" diKey предлагает наиболее привлекательные товары и услуги в определённые временные промежутки. Пользователи, открыв приложение, сразу видят специальные предложения ближайших заведений.",
    "discount.benefit1.title": "Доступно для бюджета",
    "discount.benefit1.desc": "Предложения, подходящие именно вам",
    "discount.benefit2.title": "Открывай новые места",
    "discount.benefit2.desc": "Находи заведения рядом",
    "discount.benefit3.title": "Временные предложения",
    "discount.benefit3.desc": "Максимальные скидки в лучшие часы",
    "discount.activeDeals": "Активные предложения сейчас",
    
    // Every Pocket
    "pocket.title1": "di",
    "pocket.titleK": "K",
    "pocket.title2": "ey нужен каждому",
    "pocket.description": "diKey незаменим для любого бюджета благодаря специальным скидкам в кафе, ресторанах, магазинах, на пляжах и во многих других местах.",
    "pocket.cafe": "Кафе",
    "pocket.restaurant": "Ресторан",
    "pocket.store": "Магазин",
    "pocket.beach": "Пляж",
    "pocket.more": "И многое другое",
    "pocket.earn": "₺ Зарабатывай и экономь",
    
    // Catch Section
    "catch.title1": "Не упусти, ",
    "catch.title2": "проверяй",
    "catch.title3": " diKey.",
    "catch.description": "Скидки действуют во многих сферах, и мы постоянно расширяемся!",
    
    // How It Works
    "how.title": "Как это работает?",
    "how.subtitle": "Простые шаги для бизнеса и пользователей",
    "how.forBusiness": "Для бизнеса",
    "how.forUsers": "Для пользователей",
    "how.b1.title": "Зарегистрируйтесь",
    "how.b1.desc": "Быстро добавьте своё заведение",
    "how.b2.title": "Настройте часы скидок",
    "how.b2.desc": "Определите выгодные временные слоты",
    "how.b3.title": "Сканируйте QR-код",
    "how.b3.desc": "Считайте QR-код клиента",
    "how.b4.title": "Примените скидку мгновенно",
    "how.b4.desc": "Скидка применяется автоматически",
    "how.u1.title": "Скачайте приложение",
    "how.u1.desc": "Доступно для iOS и Android",
    "how.u2.title": "Выберите предложение",
    "how.u2.desc": "Найдите лучшие скидки рядом",
    "how.u3.title": "Покажите QR-код",
    "how.u3.desc": "Предъявите код в заведении",
    "how.u4.title": "Наслаждайтесь скидкой",
    "how.u4.desc": "Экономьте сразу",
    
    // Advantages
    "adv.title": "Преимущества для всех",
    "adv.subtitle": "Бизнес увеличивает доходы, пользователи экономят",
    "adv.forBusiness": "Для бизнеса",
    "adv.forUsers": "Для пользователей",
    "adv.b1.title": "Превращение свободных часов в доход",
    "adv.b1.desc": "Привлекайте клиентов в периоды низкой загрузки",
    "adv.b2.title": "Формирование лояльных клиентов",
    "adv.b2.desc": "Растите за счёт постоянных посетителей",
    "adv.b3.title": "Управление кампаниями в реальном времени",
    "adv.b3.desc": "Мгновенно настраивайте предложения",
    "adv.u1.title": "Специальные предложения в качественных заведениях",
    "adv.u1.desc": "Скидочный опыт в лучших местах",
    "adv.u2.title": "Поиск скидок по местоположению",
    "adv.u2.desc": "Находите лучшие предложения рядом",
    "adv.u3.title": "Надёжный опыт скидок",
    "adv.u3.desc": "Проверенные и безопасные заведения",
    
    // Partner Section
    "partner.title": "Наша цепочка преимуществ",
    "partner.subtitle": "Экосистема выгод, растущая вместе с надёжными партнёрами.",
    
    // Security
    "security.title": "Безопасность и инфраструктура",
    "security.subtitle": "Ваши данные защищены по самым высоким стандартам безопасности",
    "security.f1.title": "Управление данными в соответствии с KVKK",
    "security.f1.desc": "Все данные обрабатываются в рамках законодательства",
    "security.f2.title": "Зашифрованная информация",
    "security.f2.desc": "Максимальная безопасность с end-to-end шифрованием",
    "security.f3.title": "Высокопроизводительные серверы",
    "security.f3.desc": "Корпоративная инфраструктура для бесперебойной работы",
    "security.badge1": "SSL-сертификат",
    "security.badge2": "Соответствие KVKK",
    "security.badge3": "256-битное шифрование",
    "security.badge4": "99,9% времени доступности",
    
    // Statistics
    "stats.title": "diKey в цифрах",
    "stats.subtitle": "Наглядные показатели доверия и успеха",
    
    // CTA
    "cta.title": "Не упусти возможность",
    "cta.subtitle": "Лучшие предложения рядом с вами и неожиданные специальные скидки",
    
    // FAQ
    "faq.title": "Часто задаваемые вопросы",
    "faq.subtitle": "Здесь вы найдёте ответы на все интересующие вопросы",
    "faq.q1": "Что такое diKey?",
    "faq.a1": "diKey это умная платформа скидок, которая позволяет бизнесу использовать свободные часы, а пользователям находить лучшие скидки рядом. Она предлагает выгодное решение для бизнеса и пользователей.",
    "faq.q2": "Могу ли я получить информацию о конфиденциальности и KVKK?",
    "faq.a2": "diKey придаёт большое значение конфиденциальности пользователей. Все персональные данные обрабатываются и защищаются в соответствии с требованиями KVKK. Ваши данные защищены 256-битным шифрованием и не передаются третьим лицам.",
    "faq.q3": "Как удалить свой аккаунт?",
    "faq.a3": "Для удаления аккаунта вы можете использовать опцию Настройки > Аккаунт > Удалить аккаунт в приложении. Альтернативно, вы можете отправить электронное письмо на info@diKey.app с запросом на удаление аккаунта. Процесс будет завершён в течение 48 часов.",
    
    // Footer
    "footer.tagline": "Мир, полный скидок. Каждый час новые лучшие предложения рядом с вами.",
    "footer.contact": "Контакты",
    "footer.quickLinks": "Быстрые ссылки",
    "footer.copyright": "© 2025 DiscounTurkey. Все права защищены.",
    
    // Marquee
    "marquee.1": "Мир, полный скидок",
    "marquee.2": "Каждый час новая возможность",
    "marquee.3": "Не упусти, проверяй diKey",
    "marquee.4": "Скидки везде, выгода всегда",

    // Ad Showcase
    "ad.headlinePrefix": "Скидки и преимущества по всему городу, всегда у вас в кармане.",
    "ad.brand": "Всё это diKey.",
  },
};
